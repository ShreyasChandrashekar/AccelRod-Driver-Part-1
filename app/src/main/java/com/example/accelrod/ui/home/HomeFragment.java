package com.example.accelrod.ui.home;
...
import com.example.accelrod.Common;
import com.example.accelrod.R;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    private void init() {
        ...
        currentUserRef = FirebaseDatabase.getInstance().getReference(Common.DRIVER_LOCATION_REFERENCES).child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                ...
                geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(),
                        ...
                        (key, error) -> {
                            if(error != null)
                                ...
                                Snackbar.make(mapFragment.getView(),"Your're Online",Snackbar.LENGTH_LONG).show();
