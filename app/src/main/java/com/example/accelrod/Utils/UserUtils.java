package com.example.accelrod.Utils;
...
import com.example.accelrod.Model.TokenModel;
...
public class UserUtils {
    public static void updateUser(View view, Map<String, Object> updateData) {
        FirebaseDatabase.getInstance()
                ...
                .addOnSuccessListener(aVoid -> Snackbar.make(view,"Update Information Successful",Snackbar.LENGTH_SHORT).show());
    }
